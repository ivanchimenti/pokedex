    ...
    <div class="row justify-content-center">
        <div class="col-10">
            ...
            <form action="update.php" method='POST' enctype="multipart/form-data">
                ...
                <input type="hidden" name="id_pokemon" value="<?php echo $Id; ?>">
                <div class="input-group mb-3">
                    <span class="input-group-text" id="basic-addon3">Nombre</span>
                    <input type="text" name="nombre" id="nombre" class="form-control" placeholder="Pikachu" aria-label="Nombre" value="<?php echo $Nombre; ?>" required aria-describedby="basic-addon2">
                </div>
                <div class="input-group mb-3">
                    <span class="input-group-text" id="basic-addon3">Descripcion</span>
                    <input type="text" name="descripcion" id="descripcion" class="form-control" placeholder="soy un pokemon muy interesante" aria-label="Descripcion" value="<?php echo $Descripcion; ?>" required aria-describedby="basic-addon2">
                </div>
                <div class="input-group mb-3">
                    <span class="input-group-text" id="basic-addon3">Nro. pokedex</span>
                    <input type="text" name="nroPokedex" id="nroPokedex" class="form-control" placeholder="45" aria-label="Nro. pokedex" value="<?php echo $NroPokedex; ?>" required aria-describedby="basic-addon2">
                </div>
                <div class="input-group mb-3">
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="hidden" name="nombreArchivo" id="nombreArchivo" value="<?php echo $Imagen;?>">
                    <input type="text" class="form-control" name="nombreImagen" id="nombreImagen" aria-label="nombreImagen" value="<?php echo $Imagen;?>" disabled required>
